...
# ==========================
# MAIN FRAME (TERMINAL + BUTTONS)
# ==========================

main_frame = tk.Frame(root, bg="white")
main_frame.pack(fill="both", expand=True, padx=10, pady=10)

# TERMINAL FRAME (LEFT SIDE)
terminal_frame = tk.Frame(main_frame, bg="white")
terminal_frame.pack(side=tk.LEFT, fill="both", expand=True)

# BUTTON FRAME (RIGHT SIDE)
button_frame = tk.Frame(main_frame, bg="white", width=250)
...
scan_button=tk.Button(button_frame,text="SCAN WEBSITE",font=("Arial",14,"bold"),bg="green",fg="white",width=22,command=scan_target)
scan_button.pack(pady=10)

apk_button=tk.Button(button_frame,text="SCAN APK FILE",font=("Arial",14,"bold"),bg="red",fg="white",width=22,command=scan_apk)
apk_button.pack(pady=10)

original_button=tk.Button(button_frame,text="SCAN ORIGINAL APP (DATA + OBB)",font=("Arial",14,"bold"),bg="orange",fg="white",width=22,command=scan_original_app)
original_button.pack(pady=10)

compare_button=tk.Button(button_frame,text="COMPARE APK vs ORIGINAL",font=("Arial",14,"bold"),bg="blue",fg="white",width=22,command=compare_analysis)
compare_button.pack(pady=10)

graph_button=tk.Button(button_frame,text="SHOW RISK GRAPH",font=("Arial",14,"bold"),bg="purple",fg="white",width=22,command=show_graph)
